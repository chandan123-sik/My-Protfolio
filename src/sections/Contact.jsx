...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "sikarwarnihal191@gmail.com",
    href: "mailto:sikarwarnihal191@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 9575500329",
    href: "tel:+919575500329",
  },
  {
    icon: MapPin,
    label: "Location",
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400 relative z-10">
            ...
            <div className="glass rounded-3xl p-5 md:p-8 border border-primary/30 bg-card/80 backdrop-blur-sm">
              ...
              <p className="text-muted-foreground text-sm">
                I'm currently seeking opportunities to grow as a MERN Stack
                Developer and work on impactful real-world projects. Whether
                it's a full-time role, internship, or freelance project, I'm
                always excited to collaborate, learn, and build modern web
                applications.
              </p>
            </div>
          </div>
